...
contract MSHARE is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("MShare", "MSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 MSHARE Lot for initial pools deployment
