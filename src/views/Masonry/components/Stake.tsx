...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.OCEAN, tombFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(tombFinance.OCEAN);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('OCEAN', tombFinance.OCEAN);
