...
import useRedeemOnNest from '../../hooks/useRedeemOnNest';
import useStakedBalanceOnNest from '../../hooks/useStakedBalanceOnNest';
import { getDisplayBalance } from '../../utils/formatBalance';
import useCurrentEpoch from '../../hooks/useCurrentEpoch';
import useFetchNestAPR from '../../hooks/useFetchNestAPR';

import useCashPriceInEstimatedTWAP from '../../hooks/useCashPriceInEstimatedTWAP';
import useTreasuryAllocationTimes from '../../hooks/useTreasuryAllocationTimes';
import useTotalStakedOnNest from '../../hooks/useTotalStakedOnNest';
import useClaimRewardCheck from '../../hooks/nest/useClaimRewardCheck';
...
const BackgroundImage = createGlobalStyle`
  body, html {
    background: url(${NestImage}) no-repeat !important;
...
const Nest = () => {
  ...
  const { onRedeem } = useRedeemOnNest();
  const stakedBalance = useStakedBalanceOnNest();
  const currentEpoch = useCurrentEpoch();
  const cashStat = useCashPriceInEstimatedTWAP();
  const totalStaked = useTotalStakedOnNest();
  const nestAPR = useFetchNestAPR();
              ...
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    ...
                    <Typography>{nestAPR.toFixed(2)}%</Typography>
                  </CardContent>
                </Card>
              </Grid>
