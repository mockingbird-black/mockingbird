...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({ onConfirm, onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Nest functionalities other than [Settle and withdraw] has been disabled for users
          who staked in legacy Nest. Please withdraw all balances from the previous nest after the update.
        </StyledText>
      </div>
      <ModalActions>
