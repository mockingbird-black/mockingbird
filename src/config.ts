...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    nestLaunchesAt: new Date('2022-02-10T00:00:00Z'),
  ...
  production: {
    ...
    externalTokens: {
      ...
      'MBIRD-POS-LP': ['0x2A651563C9d3Af67aE0388a5c8F89b867038089e', 18],
      'MSHARE-POS-LP': ['0x4733bc45eF91cF7CcEcaeeDb794727075fB209F2', 18],
    },
    baseLaunchDate: new Date('2021-06-02 13:00:00Z'),
    bondLaunchesAt: new Date('2020-12-03T15:00:00Z'),
    nestLaunchesAt: new Date('2020-12-11T00:00:00Z'),
    refreshInterval: 10000,
  },
};
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombFtmLPTombRewardPool: {
    name: 'Earn TOMB by Mbird-POS LP',
    poolId: 0,
    sectionInUI: 1,
