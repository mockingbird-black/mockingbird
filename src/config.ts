...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      'WHALE-POS-LP': ['0x13Fe199F19c8F719652985488F150762A5E9c3A8', 18],
      'OCEAN-POS-LP': ['0x20bc90bB41228cb9ab412036F80CE4Ef0cAf1BD5', 18],
    },
  ...
  production: {
    ...
    externalTokens: {
      ...
      'WHALE-POS-LP': ['0xEa5b4B898BAE20089890e39c6cF94a47D59A2Fc5', 18],
      'OCEAN-POS-LP': ['0x4733bc45eF91cF7CcEcaeeDb794727075fB209F2', 18],
    },
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombFtmLPTombRewardPoolOld: {
    name: 'Earn WHALE by WHALE-POS LP',
    poolId: 0,
    sectionInUI: 1,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn OCEAN by OCEAN-POS LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'TshareFtmLPTShareRewardPool',
    depositTokenName: 'OCEAN-POS-LP',
    earnTokenName: 'OCEAN',
    finished: false,
    sort: 7,
    closedForStaking: false,
